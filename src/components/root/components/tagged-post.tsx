...
import { Heart, MessageCircle, Repeat2, Users, Bookmark, BadgeCheck, MoreHorizontal } from 'lucide-react'
...
export default function TaggedPost({ reposter, originalPost }: RepostCardProps) {
  return (
    <Card className="mb-4">
      <CardHeader className="pt-4 px-6 space-y-4">
        <div className="flex items-center space-x-2">
            <Users className="h-4 w-4 text-muted-foreground" />
            <p className="text-sm text-muted-foreground">{reposter.name} is tagged.</p>
        </div>
